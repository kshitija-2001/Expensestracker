...
Name=StringVar()
nameLabel=Label(root, text="User",font=('arial',15,'bold'),bg="DodgerBlue2",fg="white",width=12)
...
Expense=IntVar()
expenseLabel=Label(root,text="Cost",font=('arial',15,'bold'),bg="DodgerBlue2",fg="white",width=12)
...
viewtn=Button(root,command=viewexpense,text="Show expenses",font=('arial',15,'bold'),bg="DodgerBlue2",fg="white",width=12 )
